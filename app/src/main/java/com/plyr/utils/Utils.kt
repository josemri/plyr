...
/**
 * Formatea tiempo en milisegundos a formato extendido HH:MM:SS si es necesario.
 * 
 * @param ms Tiempo en milisegundos
 * @return Tiempo formateado como "MM:SS" o "HH:MM:SS" según la duración
 */
@SuppressLint("DefaultLocale")
fun formatTimeExtended(ms: Long): String {
    val totalSeconds = ms / 1000
